 ...
 */
public class HashicorpVaultTokenAuthClient {
    ...
    private final HashicorpVaultTokenAuthSettings settings;
    private final Monitor monitor;

    public HashicorpVaultTokenAuthClient(@NotNull EdcHttpClient httpClient,
                                @NotNull ObjectMapper objectMapper,
                                @NotNull Monitor monitor,
                                @NotNull HashicorpVaultTokenAuthSettings settings) {
