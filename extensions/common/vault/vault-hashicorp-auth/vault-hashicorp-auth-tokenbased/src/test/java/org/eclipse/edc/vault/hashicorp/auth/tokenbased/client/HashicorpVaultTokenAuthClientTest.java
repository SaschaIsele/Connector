...
class HashicorpVaultTokenAuthClientTest {
    ...
    private static final HashicorpVaultTokenAuthSettings HASHICORP_VAULT_CLIENT_CONFIG_VALUES = HashicorpVaultTokenAuthSettings.Builder.newInstance()
            .url(VAULT_URL)
            .token(VAULT_TOKEN)
            .ttl(VAULT_TOKEN_TTL)
    ...
    private final HashicorpVaultTokenAuthClient vaultClient = new HashicorpVaultTokenAuthClient(
            httpClient,
            OBJECT_MAPPER,
            monitor,
