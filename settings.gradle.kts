...
include(":extensions:common:vault:vault-hashicorp-auth")
include(":extensions:common:vault:vault-hashicorp-auth:vault-hashicorp-auth-tokenbased")
include(":extensions:common:vault:vault-hashicorp-auth:vault-hashicorp-auth-kubernetes")
...
include(":spi:common:hashicorp-vault-auth-spi")
