...
--------------------------------
**Artifact:** org.eclipse.edc:identity-trust-sts-core:0.12.0-SNAPSHOT
...
-----------------------------------------
**Artifact:** org.eclipse.edc:identity-trust-sts-remote-client:0.12.0-SNAPSHOT
...
Module `jersey-core`
--------------------
**Artifact:** org.eclipse.edc:jersey-core:0.12.0-SNAPSHOT
...
--------------------------
**Artifact:** org.eclipse.edc:jersey-micrometer:0.12.0-SNAPSHOT
...
Module `jetty-core`
-------------------
**Artifact:** org.eclipse.edc:jetty-core:0.12.0-SNAPSHOT
...
| ~~web.http.default.port~~           | `*`      | `string` | `8181`     |         |     |     | Port for default api context |
| ~~web.http.default.path~~           | `*`      | `string` | `/api`     |         |     |     | Path for default api context |
...
-------------------------
**Artifact:** org.eclipse.edc:jetty-micrometer:0.12.0-SNAPSHOT
...
Module `json-ld`
----------------
**Artifact:** org.eclipse.edc:json-ld:0.12.0-SNAPSHOT
...
---------------------------------
**Artifact:** org.eclipse.edc:jti-validation-store-sql:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:jwt-signer-spi:0.12.0-SNAPSHOT
...
----------------
**Name:** JTW services
**Artifact:** org.eclipse.edc:jwt-spi:0.12.0-SNAPSHOT
...
-------------------------------------
**Artifact:** org.eclipse.edc:management-api-configuration:0.12.0-SNAPSHOT
...
------------------------
**Artifact:** org.eclipse.edc:micrometer-core:0.12.0-SNAPSHOT
...
---------------------------
**Artifact:** org.eclipse.edc:monitor-jdk-logger:0.12.0-SNAPSHOT
...
----------------------
**Artifact:** org.eclipse.edc:oauth2-client:0.12.0-SNAPSHOT
...
Module `oauth2-core`
--------------------
**Artifact:** org.eclipse.edc:oauth2-core:0.12.0-SNAPSHOT
...
| Key                                     | Required | Type     | Default                           | Pattern | Min | Max | Description                                                                                   |
| --------------------------------------- | -------- | -------- | --------------------------------- | ------- | --- | --- | --------------------------------------------------------------------------------------------- |
| `edc.oauth.provider.jwks.url`           | `*`      | `string` | `http://localhost/empty_jwks_url` |         |     |     | URL to obtain OAuth2 JSON Web Key Sets                                                        |
| `edc.oauth.token.url`                   | `*`      | `string` | ``                                |         |     |     | OAuth2 Token URL                                                                              |
| `edc.oauth.client.id`                   | `*`      | `string` | ``                                |         |     |     | OAuth2 client ID                                                                              |
| `edc.oauth.private.key.alias`           | `*`      | `string` | ``                                |         |     |     | Vault alias for the private key                                                               |
| `edc.oauth.certificate.alias`           | `*`      | `string` | ``                                |         |     |     | Vault alias for the certificate                                                               |
| `edc.oauth.provider.audience`           |          | `string` | ``                                |         |     |     | outgoing tokens 'aud' claim value, by default it's the connector id                           |
| `edc.oauth.validation.nbf.leeway`       | `*`      | `string` | `10`                              |         |     |     | Leeway in seconds for validating the not before (nbf) claim in the token.                     |
| `edc.oauth.validation.issued.at.leeway` | `*`      | `string` | `0`                               |         |     |     | Leeway in seconds for validating the issuedAt claim in the token. By default it is 0 seconds. |
| `edc.oauth.endpoint.audience`           |          | `string` | ``                                |         |     |     | incoming tokens 'aud' claim required value, by default it's the provider audience value       |
| `edc.oauth.provider.jwks.refresh`       | `*`      | `string` | `5`                               |         |     |     | Refresh time for the JWKS, in minutes                                                         |
| `edc.oauth.token.expiration`            | `*`      | `string` | `5`                               |         |     |     | Token expiration in minutes. By default is 5 minutes                                          |
| `edc.oauth.token.resource.enabled`      | `*`      | `string` | `false`                           |         |     |     | Enable the connector to request a token with a specific audience as defined in the RFC-8707.  |
...
Module `oauth2-daps`
--------------------
**Artifact:** org.eclipse.edc:oauth2-daps:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:oauth2-spi:0.12.0-SNAPSHOT
...
------------------------------
**Artifact:** org.eclipse.edc:policy-definition-api:0.12.0-SNAPSHOT
...
------------------------------------
**Artifact:** org.eclipse.edc:policy-definition-store-sql:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:policy-engine-spi:0.12.0-SNAPSHOT
...
----------------------------
**Artifact:** org.eclipse.edc:policy-monitor-core:0.12.0-SNAPSHOT
...
| Key                                                      | Required | Type     | Default | Pattern | Min | Max | Description                                                                                     |
| -------------------------------------------------------- | -------- | -------- | ------- | ------- | --- | --- | ----------------------------------------------------------------------------------------------- |
| `edc.policy.monitor.state-machine.iteration-wait-millis` | `*`      | `string` | `1000`  |         |     |     | the iteration wait time in milliseconds in the policy monitor state machine. Default value 1000 |
| `edc.policy.monitor.state-machine.batch-size`            | `*`      | `string` | `20`    |         |     |     | the batch size in the policy monitor state machine. Default value 20                            |
...
---------------------------------
**Artifact:** org.eclipse.edc:policy-monitor-store-sql:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:policy-spi:0.12.0-SNAPSHOT
...
-----------------------------
**Artifact:** org.eclipse.edc:protocol-version-api:0.12.0-SNAPSHOT
...
-----------------------
**Artifact:** org.eclipse.edc:provision-http:0.12.0-SNAPSHOT
...
Module `secrets-api`
--------------------
**Artifact:** org.eclipse.edc:secrets-api:0.12.0-SNAPSHOT
...
-------------------------
**Artifact:** org.eclipse.edc:sql-bootstrapper:0.12.0-SNAPSHOT
...
Module `sql-core`
-----------------
**Artifact:** org.eclipse.edc:sql-core:0.12.0-SNAPSHOT
...
--------------------------------
**Artifact:** org.eclipse.edc:sql-pool-apache-commons:0.12.0-SNAPSHOT
...
Module `sts-server`
-------------------
**Artifact:** org.eclipse.edc:sts-server:0.12.0-SNAPSHOT
...
Module `token-core`
-------------------
**Artifact:** org.eclipse.edc:token-core:0.12.0-SNAPSHOT
...
------------------
**Name:** Token services
**Artifact:** org.eclipse.edc:token-spi:0.12.0-SNAPSHOT
...
-----------------------------
**Artifact:** org.eclipse.edc:transaction-atomikos:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:transaction-datasource-spi:0.12.0-SNAPSHOT
...
--------------------------
**Artifact:** org.eclipse.edc:transaction-local:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:transaction-spi:0.12.0-SNAPSHOT
...
--------------------------------------
**Artifact:** org.eclipse.edc:transfer-data-plane-signaling:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:transfer-data-plane-spi:0.12.0-SNAPSHOT
...
-----------------------------
**Artifact:** org.eclipse.edc:transfer-process-api:0.12.0-SNAPSHOT
...
-----------------------------------
**Artifact:** org.eclipse.edc:transfer-process-store-sql:0.12.0-SNAPSHOT
...
--------------------------------------------
**Artifact:** org.eclipse.edc:transfer-pull-http-dynamic-receiver:0.12.0-SNAPSHOT
...
------------------------------------
**Artifact:** org.eclipse.edc:transfer-pull-http-receiver:0.12.0-SNAPSHOT
...
**Artifact:** org.eclipse.edc:transfer-spi:0.12.0-SNAPSHOT
...
-----------------------------------------
**Artifact:** org.eclipse.edc:validator-data-address-http-data:0.12.0-SNAPSHOT
...
-------------------------------------
**Artifact:** org.eclipse.edc:validator-data-address-kafka:0.12.0-SNAPSHOT
...
------------------------
**Artifact:** org.eclipse.edc:vault-hashicorp:0.12.0-SNAPSHOT
...
-------------------------------
**Artifact:** org.eclipse.edc:verifiable-credentials:0.12.0-SNAPSHOT
...
Module `version-api`
--------------------
**Artifact:** org.eclipse.edc:version-api:0.12.0-SNAPSHOT
...
----------------
**Name:** Web services
**Artifact:** org.eclipse.edc:web-spi:0.12.0-SNAPSHOT
